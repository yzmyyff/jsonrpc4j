...
public class MultiServiceTest {
	...
	public void setup() {
		...
		multiServer.addService("Test", new Service(), ServiceInterfaceWithParamNameAnnotation.class);
	...
	private class Service implements ServiceInterfaceWithParamNameAnnotation {
